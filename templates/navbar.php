    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav me-auto">
                ...
                <?php if ($role == 'siswa'): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/siswa">Dashboard</a>
                    </li>
                    <li class="nav-item">
                ...
                <?php elseif ($role == 'guru'): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/guru">Dashboard</a>
                    </li>
                    <li class="nav-item">
                ...
                <?php elseif ($role == 'walikelas'): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= BASE_URL ?>/walikelas">Dashboard</a>
                    </li>
                    <li class="nav-item">
